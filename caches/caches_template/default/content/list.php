...
<div class="w1000">
    ...
    <div class="erright">
        ...
        <div class="erright_top">
                <div class="erright_title"><img src="<?php echo IMG_PATH;?>/myimg/about_title.jpg" alt=""/></div>
        ...
        <div class="dh26"></div>
        <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=b623ac1a78ebb422472bafc31215b01f&action=lists&catid=%24catid&moreinfo=1&num=5\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {$data = $content_tag->lists(array('catid'=>$catid,'moreinfo'=>'1','limit'=>'5',));}?>
        <div class="about">
