...
<div class="main">
    ...
    <div class="w1000">
        ...
        <div class="erright">
            ...
            <div class="dh26"></div>
            <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=1a93880f5a081c13afa913c69cfb508c&action=lists&catid=%24catid&num=8\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {$data = $content_tag->lists(array('catid'=>$catid,'limit'=>'8',));}?>
            <div class="about">
                <?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
                <dl>
